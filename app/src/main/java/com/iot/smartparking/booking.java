        ...
        switch (v.getId()){
            case R.id.parkingBtnSubmit:
                ...
                if(checkData()){
                    ...
                    map.put("slotNo", strSpotNumber);
                    myRef.child("parkingReceipt").child(userId).push().setValue(map);
                    Toast.makeText(booking.this, "Parking reciept successful", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(booking.this, viewbooking.class);
