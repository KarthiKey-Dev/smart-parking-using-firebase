...
import com.iot.smartparking.ParkingReportAdapter;
...
public class viewbooking extends AppCompatActivity implements ParkingReportAdapter.ListItemClickListener {
    ...
    public void onListItemClick(int clickedItemIndex) {
        ...
        Intent intent = new Intent(viewbooking.this, parkingreportdetail.class);
